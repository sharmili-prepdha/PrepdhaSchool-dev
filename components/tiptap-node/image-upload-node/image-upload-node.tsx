...
const FileCornerIcon: React.FC = () => (
  <svg
    width="10"
    height="10"
    className="absolute right-1 top-0 bottom-0 text-neutral-300 dark:text-neutral-600"
    viewBox="0 0 10 10"
    fill="currentColor"
    xmlns="http://www.w3.org/2000/svg"
  >
...
const ImageUploadDragArea: React.FC<ImageUploadDragAreaProps> = ({
  ...
  return (
    <div
      className={cn(
        "image-upload-drag-area relative cursor-pointer overflow-hidden rounded-md border-[1.5px] border-dashed border-neutral-300 px-6 py-8 text-center transition-all duration-200 hover:border-neutral-400 max-sm:px-4 max-sm:py-6",
...
const ImageUploadPreview: React.FC<ImageUploadPreviewProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-md">
      ...
      <div className="relative flex items-center justify-between rounded-md border border-neutral-300 p-4 max-sm:p-3 dark:border-neutral-600">
        <div className="flex h-8 items-center gap-3">
          <div className="flex size-7 items-center justify-center rounded-lg bg-primary p-2">
            <CloudUploadIcon />
          </div>
...
const DropZoneContent: React.FC<{ maxSize: number; limit: number }> = ({
  ...
  <>
    <div className="relative inline-flex h-15 w-12.5 select-none items-start justify-center">
      <FileIcon />
      <FileCornerIcon />
      <div className="absolute bottom-0 right-0 flex size-7 items-center justify-center rounded-lg bg-primary">
        <CloudUploadIcon />
      </div>
    </div>

    <div className="flex flex-col items-center justify-center gap-1 select-none">
      <span className="text-sm font-medium leading-normal text-neutral-700 dark:text-neutral-300 [&_em]:font-normal [&_em]:underline">
        <em>Click to upload</em> or drag and drop
      </span>
      <span className="text-xs font-semibold leading-normal text-neutral-400 dark:text-neutral-500">
...
export const ImageUploadNode: React.FC<NodeViewProps> = (props) => {
  ...
  return (
    <NodeViewWrapper
      className="my-8 [&_input[type=file]]:hidden"
      tabIndex={0}
      onClick={handleClick}
    >
      {!hasFiles && (
      ...
      {hasFiles && (
        <div className="flex flex-col gap-3">
          {fileItems.length > 1 && (
            <div className="mb-2 flex items-center justify-between border-b border-neutral-300 py-2 max-sm:flex-col max-sm:items-start max-sm:gap-2 dark:border-neutral-600">
              <span className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
