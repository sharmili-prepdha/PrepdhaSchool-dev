  ...
  function TooltipContent(
    ...
    const content = (
      <div
        ...
        className="z-200 overflow-hidden rounded-md bg-neutral-900 px-2 py-1.5 text-center text-xs font-medium text-white shadow-md dark:bg-white dark:text-neutral-600 [&_kbd]:inline-block [&_kbd]:align-baseline [&_kbd]:font-sans [&_kbd]:capitalize [&_kbd]:text-neutral-400 [&_kbd]:dark:text-neutral-500"
      >
        {children}
      </div>
    )
