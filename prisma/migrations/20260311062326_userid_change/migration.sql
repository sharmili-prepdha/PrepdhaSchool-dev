...
-- CreateTable
CREATE TABLE "StudentTopicRevision" (
    "id" SERIAL NOT NULL,
    "student_id" INTEGER NOT NULL,
    "topic_id" INTEGER NOT NULL,
    "current_interval_in_days" INTEGER NOT NULL,
    "last_interval_at" DATE NOT NULL,
    "next_revision_at" DATE NOT NULL,
    "revision_counter" INTEGER NOT NULL DEFAULT 1,
    "is_pending" BOOLEAN NOT NULL DEFAULT true,

    CONSTRAINT "StudentTopicRevision_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "StudentTopicRevision_student_id_idx" ON "StudentTopicRevision"("student_id");

-- CreateIndex
CREATE INDEX "StudentTopicRevision_topic_id_idx" ON "StudentTopicRevision"("topic_id");

-- CreateIndex
CREATE INDEX "StudentTopicRevision_current_interval_in_days_idx" ON "StudentTopicRevision"("current_interval_in_days");
...
-- AddForeignKey
ALTER TABLE "StudentTopicRevision" ADD CONSTRAINT "StudentTopicRevision_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StudentTopicRevision" ADD CONSTRAINT "StudentTopicRevision_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "Topic"("id") ON DELETE CASCADE ON UPDATE CASCADE;
